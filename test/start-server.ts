import { initManager, manager } from '@makcimbx/opencode-pty/plugin/pty/manager'
import { PTYServer } from '@makcimbx/opencode-pty/web/server/server'
import { OpencodeClient } from '@opencode-ai/sdk'
import { createApiClient } from '@makcimbx/opencode-pty/web/shared/api-client'
...
if (process.env.NODE_ENV === 'test' && process.env.CREATE_TEST_SESSION !== 'false') {
